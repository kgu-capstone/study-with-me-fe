...
export default class GoogleLogin extends Component {
  ...
  handleLogin = async () => {
    const redirectUrl = encodeURIComponent(`${process.env.REACT_APP_BASE_URL}SignIn`);
  ...
  handleCallback = async () => {
    ...
    const redirectUrl = encodeURIComponent(`${process.env.REACT_APP_BASE_URL}SignIn`); // Redirect Url -> handleLogin의 redirectUri와 반드시 일치
