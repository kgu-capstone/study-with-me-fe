        ...
        <div className={styles.center_arrange}>
          ...
          <div>
            ...
            <div className={`${styles.recruit_toggles_contianer}`}>
              <input type='radio' name='isRercuit' id='yesRecruit' className={`${styles.recruit_toggles_input}`} onClick={() => handleRecruit('online')} /><label htmlFor='yesRecruit' className={recruitOnclass}>ON</label>
              <input type='radio' name='isRercuit' id='notRecruit' className={`${styles.recruit_toggles_input}`} onClick={() => handleRecruit('offline')} /><label htmlFor='notRecruit' className={recruitOffclass}>OFF</label>
            </div>
          </div>
          ...
          <NavLink to="/StudyWork" state={{ studyId: stateStudyId }} className={styles.make_study_button_nav}>
